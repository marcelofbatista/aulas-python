...
Escreva uma estrutura condicional onde, se a idade for maior ou igual a 18, o terminal
imprima: "Você é obrigado a votar". Caso contrário, imprima: "Você ainda não é obrigado a votar".
